...
\+: definim un punt a traves de les coordenades x i y; 
\end{DoxyPostcond}

\begin{DoxyParams}{Paràmetres}
{\em fila} & valor del eix de les absices; \\
\hline
{\em columna} & valor del eix de les ordenades; \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Paràmetres}
{\em desti} & punt de referencia per calcular la distancia; \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Retorna}
\+: la distancia al quadrat de contra destí; 
\end{DoxyReturn}
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondició}
\+: retornem el punt obtingut de aplicar un moviment; 
\end{DoxyPostcond}

\begin{DoxyParams}{Paràmetres}
{\em moviment} & a aplicar; \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Retorna}
punt desplaçat per moviment; 
\end{DoxyReturn}
...
\end{DoxyPostcond}
\begin{DoxyReturn}{Retorna}
\+: valor del eix de les ordenades; 
\end{DoxyReturn}
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondició}
\+:em donat les 4 posicions del voltant; 
\end{DoxyPostcond}
\begin{DoxyReturn}{Retorna}
\+: les 4 posicions del voltant; 
\end{DoxyReturn}


La documentació d'aquesta classe es va generar a partir del següent fitxer\+:\begin{DoxyCompactItemize}
\item 
/home/oscar/\+Desktop/\+Proj\+Prog/\+Projecte/src/logica/Punt.\+java\end{DoxyCompactItemize}
